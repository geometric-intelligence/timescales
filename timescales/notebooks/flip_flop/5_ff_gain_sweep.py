...
if tanh_eig_data:
    ...
    fp_dt = fp_config["dt"]
    fp_tau = fp_config["time_constants_config"]["values"][0]
    ...
    fp_model = RNN(
        ...
        dt=fp_config["dt"],
        time_constants_config=fp_config.get("time_constants_config"),
        activation=getattr(nn, fp_config["activation"]),
        learn_time_constants=fp_config["learn_time_constants"],
        init_time_constant=fp_config.get("init_time_constant"),
        shared_time_constant=fp_config["shared_time_constant"],
