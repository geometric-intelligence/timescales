...
def generate_W_levy(n_neurons, alpha_stab, normalization="rnn"):
    ...
    normalization="rnn"    → scale = 1/sqrt(N)  [matches RNN levy_stable init]
...
#
# - `"rnn"`: scale = 1/√N — matches `RNN` init; spectral radius grows for small α.
...
alpha_sweep_config = {
    ...
    #   "rnn"    → scale = 1/sqrt(N)    matches RNN levy_stable init
